...
public class AcMediaDemo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar.setTitle("Aceleração");

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        mChart = (LineChart) findViewById(R.id.chartAcMedia);

        mChart.setDescription("Aceleração x Tempo");
        ...
        txtAceleracao = (TextView) findViewById(R.id.txtAcel);
            ...
            public void handleMessage(android.os.Message msg) {
                if (msg.what == handlerState) {
                    ...
                    if (endOfLineIndex > 0) {
                        ...
                        int f = dataInPrint.indexOf("f");
                        String ace = dataInPrint.substring(c+1, f);
                        txtAceleracao.setText(ace);
                        feedMultiple(ace);
