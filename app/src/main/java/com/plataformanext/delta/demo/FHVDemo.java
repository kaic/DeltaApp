...
public class FHVDemo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChart = (LineChart) findViewById(R.id.chartFHV);

        mChart.setDescription("Velocidade x Tempo");
        ...
        txtFHV = (TextView) findViewById(R.id.txtFHV);
            ...
            public void handleMessage(android.os.Message msg) {
                if (msg.what == handlerState) {
                    ...
                    if (endOfLineIndex > 0) {
                        ...
                        String fhv = dataInPrint.substring(f + 1, endOfLineIndex);
                        txtFHV.setText(fhv);
                        feedMultiple(fhv);
